...
'''
Please enter an operation and 2 parameters...
add 34,12
The answer is: 46 
 
Assertion 1: 6 add 12 should be 18...
 
The answer is: 18 
 
Assertion 2: 626 subtract 100 should be 526...
 
The answer is: 526 
 
Assertion 3: 54 plus 8 should be Unknown command entered!...
 
Unknown command entered!
'''

'''
User input can be shared with different classes using a mediator class within
the Mediator Method pattern. We can have a main method that gets user input and
shares it to the mediator class. Then we can have different calculation classes
which would like to share this input through the mediator class. This is a
clean and effective way to share data between classes, as it is manageable and
easy to refactor.
'''
